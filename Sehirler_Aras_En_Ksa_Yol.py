...
# Dijkstra Algoritmasý Türkiye Haritasýna Uygulanýlýþý
# En küçük maliyetli yolun bulunmasý
# Bu kod KTÜ Bilgisayar Mühendisliði Bölümü'nde staj yapan öðrenci tarafýndan hazýrlanmýþtýr.
# Yazar: Beytullah Bilek 
...
for i in range(0,81):   # açýklma þehir bilgilerini tutan liste
  information.append(list(cityinf[i].values()))

def dist(a,b):  # 2 nokta arasýndaki mesafeyi hesaplar
...
graph={#türkiye þehir haritasý þehir komþuluklarý
  ...
  '6' : {'42':0,'68':0,'40':0,'71':0,'18':0,'14':0,'26':0,'3':0},
...
print("minimum yolun bulunmasýný istediðiniz iki þehrin plakalarýný giriniz")
say1=input("baþlanacak ilin plakasý--> ")
say2=input("varýlmasý istenen ilin plakasý1--> ")
